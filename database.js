...
const pool = new Pool({
    connectionString: process.env.DATABASE_URL || 'postgresql://neondb_owner:npg_lzWeA5f4RIUJ@ep-young-darkness-alnbgfe7.c-3.eu-central-1.aws.neon.tech/neondb?sslmode=require',
